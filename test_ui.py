...
check("no app.js id is missing from index.html", not missing)

# sanity: the key controls added over time are all present
for _id in ["build", "margin", "sections",
            "save-project", "load-project", "add-exclusion", "clear-exclusions",
            "save-exclusions", "edit-exclusions", "anchor-source", "my-position",
            ...
            "mav-baud", "mav-follow", "set-start", "export-flights",
            "exp-kml", "import-kml", "kml-file", "export-flights-csv", "start-finish",
            "split-field", "clear-split"]:
