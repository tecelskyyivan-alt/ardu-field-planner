...
Object.assign(window.FMP_TR, {
  ...
  "Вирізано {0} ділянок ЛЕП з OSM (ширина {1} м). OSM неповний — ПЕРЕВІР ОЧИМА! Зміни ширину й тисни ще раз — старі авто-вирізи заміняться. Перебудуй маршрут.": "Cut {0} power-line segments from OSM ({1} m wide). OSM is incomplete — VERIFY WITH YOUR EYES! Change the width and press again — the old auto-cuts are replaced. Rebuild the route.",
  "Виріз завширшки {0} м створено. Перебудуй маршрут — він його обійде.": "A {0} m wide cut was created. Rebuild the route — it will avoid it.",
